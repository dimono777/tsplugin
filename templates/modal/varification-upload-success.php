...
<div id="js_verPopup" class="ver-popup-wrapper">
    <div class="box-modal-wrapper">
		...
		<h2 class="box-modal-title success"><?php echo \TS_Functions::__('Document Submitted!'); ?></h2>

		<div class="box-modal-description">
			<p>
				<?php echo \TS_Functions::__('We have received your document.'); ?>
				<?php echo \TS_Functions::__('A response from a billing agent will be emailed to you within the next 48 business hours.'); ?>
			</p>
		</div>
		<div class="buttons-wrap">
            ...
            $form = Form::begin(
                ...
                [
                    ...
                    'htmlOptions'            => ['id'      => 'verification-upload-popup',
