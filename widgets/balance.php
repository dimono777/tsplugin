...
class Balance_Widget extends \tradersoft\widgets\base\Widget {

	public function __construct() {
		$widget_ops = array(
			'classname' => 'balance_widget',
			'description' => \TS_Functions::__( 'Balance' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'balance', \TS_Functions::__( 'TraderSoft Balance Block!' ), $widget_ops, $control_ops );
	}
    ...
    {
        return \TS_Functions::__( 'Balance' );
    }
