...
class Hello_Widget extends \tradersoft\widgets\base\Widget {

	public function __construct() {
		$widget_ops = array(
			'classname' => 'hello_widget',
			'description' => \TS_Functions::__( 'Hello User!' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'hello', \TS_Functions::__( 'TraderSoft Hello User!' ), $widget_ops, $control_ops );
	}
    ...
    {
        return \TS_Functions::__( 'Hello User!' );
    }
}
