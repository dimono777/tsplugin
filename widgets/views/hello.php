    ...
    <div class="user-authorization">
        ...
        <div class="user-name dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                ...
                <li><a href="<?php echo Platform::getURL(Platform::URL_VERIFICATION)?>"><?php echo \TS_Functions::__('Verify Account') ?></a></li>
        ...
        <div class="user-balance">
            <div class="title"><?php echo \TS_Functions::__('Balance:') ?></div>
            <div class="balance">
                <?php echo \tradersoft\helpers\Currency::getInstance()->getSymbol() ?><span id = "header-user-balance"><?php echo $trader->getBalance() ?></span>
            </div>
        </div>
